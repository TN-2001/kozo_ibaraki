...
class TrussBar extends StatefulWidget {
  const TrussBar({super.key, required this.controller, required this.scaffoldKey});

  final TrussData controller;
  final GlobalKey<ScaffoldState> scaffoldKey;

  @override
  State<TrussBar> createState() => _TrussBarState();
}

class _TrussBarState extends State<TrussBar> {
