...
class DataManager extends ChangeNotifier {
  ...
  double get nodeRadius {
    ...
    if (newRect.width > newRect.height) {
      return newRect.width * 1.5 / 100;
    } else {
      return newRect.height * 1.5 / 100;
    }
  }
...
class Node extends ChangeNotifier {
  ...
  final List<bool> _const = [
    false,
    false,
    false,
    false
  ]; // 拘束条件 0:水平、1：鉛直、2：回転、3:ヒンジ
  ...
  final List<double> _result = [
    ...
    0.0,
    0.0
  ]; // 0:水平方向の反力、1:垂直方向の反力、2:モーメン、3:たわみ角
...
class Elem extends ChangeNotifier {
  ...
  final List<double> _result = [
    ...
    0.0,
    0.0
  ]; // 0:軸力、1:せん断力、2:曲げモーメント、3:曲げモーメントa, 4: 曲げモーメントb
